...
**Generated on:** 2025-09-07 00:23:31  
**Model ID:** `abd146b2-e89f-4c4a-be39-c17767fcc5cc`  
**Model Folder:** `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc`
...
### Key Results
- **Final Cross-Validation MAE:** 0.197719
- **Best Hyperparameters Found:** {
  "lr": 0.0012089300956366217,
  "batch_size": 128,
  "drop_out": 0.22859491540745652,
  "unit": 112,
  "layber_number": 1
}
- **Optimization Time:** 52.16 seconds
...
**Best Cross-Validation Score:** 0.162058

### 3.3 Hyperparameter Optimization Trials

The complete hyperparameter optimization results are saved in:
- **File:** `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/hyperparameter_optimization_trials.csv`
- **Total Trials:** 50
...
| Metric | Value |
|--------|-------|
| Average CV MAE | 0.197719 |
| CV Standard Deviation | 0.026546 |
| Best Fold MAE | 0.175558 |
| Worst Fold MAE | 0.239562 |
...
![Training Curves](./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/training_curves.png)

**File:** `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/training_curves.png`
...
**File:** `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/training_history.csv`
...
![CV Predictions](./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/cv_predictions_scatter.png)

**File:** `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/cv_predictions_scatter.png`
...
| Metric | Value |
|--------|-------|
| Cross-Validation MAE | 0.197701 |
| Cross-Validation R² | 0.942055 |
| Number of Predictions | 53 |
| Prediction Range | [-1.591, 2.457] |
| Actual Range | [-1.673, 2.342] |

**Prediction Data Files:**
- `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/cv_predictions.csv` - Basic predictions data
...
| Dropout Rate | 0.22859491540745652 |
...
1. **Model Performance**: The optimized neural network achieved a cross-validation MAE of 0.197719
...
- **Model Weights**: Saved in `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/`
- **Hyperparameters**: `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/model_metadata.json`
- **Training Data**: `./H-AF.xls`
- **Training History**: `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/training_history.csv`
- **Optimization Trials**: `./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/hyperparameter_optimization_trials.csv`
...
- **Generation Time**: 2025-09-07 00:23:31
- **Model ID**: `abd146b2-e89f-4c4a-be39-c17767fcc5cc`
...
```
./trained_model/abd146b2-e89f-4c4a-be39-c17767fcc5cc/
