...
**Generated on:** 2025-09-04 18:24:49  
**Model ID:** `10a580b7-e2e4-4976-b3e9-d79e8357966c`  
**Model Folder:** `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c`
...
### Key Results
- **Final Cross-Validation MAE:** 0.184424
- **Best Hyperparameters Found:** {
  "lr": 0.00023475054873676652,
  "batch_size": 112,
  "drop_out": 0.14634606768636768,
  "unit": 112,
  "layber_number": 1
}
- **Optimization Time:** 107.39 seconds
...
**Best Cross-Validation Score:** 0.159584

### 3.3 Hyperparameter Optimization Trials

The complete hyperparameter optimization results are saved in:
- **File:** `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/hyperparameter_optimization_trials.csv`
- **Total Trials:** 100
...
| Metric | Value |
|--------|-------|
| Average CV MAE | 0.184424 |
| CV Standard Deviation | 0.050416 |
| Best Fold MAE | 0.129824 |
| Worst Fold MAE | 0.260673 |
...
![Training Curves](./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/training_curves.png)

**File:** `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/training_curves.png`
...
**File:** `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/training_history.csv`
...
![CV Predictions](./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/cv_predictions_scatter.png)

**File:** `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/cv_predictions_scatter.png`
...
| Metric | Value |
|--------|-------|
| Cross-Validation MAE | 0.183835 |
| Cross-Validation R² | 0.945019 |
| Number of Predictions | 53 |
| Prediction Range | [-1.751, 2.253] |
| Actual Range | [-1.673, 2.342] |

**Prediction Data Files:**
- `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/cv_predictions.csv` - Basic predictions data
...
| Dropout Rate | 0.14634606768636768 |
...
1. **Model Performance**: The optimized neural network achieved a cross-validation MAE of 0.184424
...
- **Model Weights**: Saved in `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/`
- **Hyperparameters**: `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/model_metadata.json`
- **Training Data**: `./H-AF.xls`
- **Training History**: `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/training_history.csv`
- **Optimization Trials**: `./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/hyperparameter_optimization_trials.csv`
...
- **Generation Time**: 2025-09-04 18:24:49
- **Model ID**: `10a580b7-e2e4-4976-b3e9-d79e8357966c`
...
```
./trained_model/10a580b7-e2e4-4976-b3e9-d79e8357966c/
