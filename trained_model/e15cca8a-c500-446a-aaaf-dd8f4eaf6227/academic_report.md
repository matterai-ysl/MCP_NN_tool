...
**Generated on:** 2025-09-04 21:30:23  
**Model ID:** `e15cca8a-c500-446a-aaaf-dd8f4eaf6227`  
**Model Folder:** `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227`
...
### Key Results
- **Final Cross-Validation MAE:** 0.201260
- **Best Hyperparameters Found:** {
  "lr": 0.00017395425782709982,
  "batch_size": 48,
  "drop_out": 0.08310222098662862,
  "unit": 96,
  "layber_number": 8
}
- **Optimization Time:** 140.84 seconds
...
**Best Cross-Validation Score:** 0.169652

### 3.3 Hyperparameter Optimization Trials

The complete hyperparameter optimization results are saved in:
- **File:** `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/hyperparameter_optimization_trials.csv`
- **Total Trials:** 100
...
| Metric | Value |
|--------|-------|
| Average CV MAE | 0.201260 |
| CV Standard Deviation | 0.047164 |
| Best Fold MAE | 0.148176 |
| Worst Fold MAE | 0.284779 |
...
![Training Curves](./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/training_curves.png)

**File:** `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/training_curves.png`
...
**File:** `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/training_history.csv`
...
![CV Predictions](./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/cv_predictions_scatter.png)

**File:** `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/cv_predictions_scatter.png`
...
| Metric | Value |
|--------|-------|
| Cross-Validation MAE | 0.200271 |
| Cross-Validation R² | 0.929613 |
| Number of Predictions | 53 |
| Prediction Range | [-1.614, 2.166] |
| Actual Range | [-1.673, 2.342] |

**Prediction Data Files:**
- `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/cv_predictions.csv` - Basic predictions data
...
| Dropout Rate | 0.08310222098662862 |
...
1. **Model Performance**: The optimized neural network achieved a cross-validation MAE of 0.201260
...
- **Model Weights**: Saved in `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/`
- **Hyperparameters**: `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/model_metadata.json`
- **Training Data**: `/Users/ysl/Desktop/Code/MCP_NN_Tool/H-AF.xls`
- **Training History**: `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/training_history.csv`
- **Optimization Trials**: `./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/hyperparameter_optimization_trials.csv`
...
- **Generation Time**: 2025-09-04 21:30:23
- **Model ID**: `e15cca8a-c500-446a-aaaf-dd8f4eaf6227`
...
```
./trained_model/e15cca8a-c500-446a-aaaf-dd8f4eaf6227/
